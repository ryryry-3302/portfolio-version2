...
const projects: Project[] = [
	...
	},
	{
		...
		date: "Jan 2025",
		title: "ORB SLAM3",
		description: "Visual-inertial SLAM implementation using ORB-SLAM3 for real-time pose estimation and mapping in dynamic environments.",
	...
	},
	{
		...
		description: "Electromagnetic motion capture system for real-time full-body tracking with sub-millimeter accuracy.",
		tags: ["C++", "Python", "ROS 2", "Kalman Filter"],
	},
	{
		slug: "leasy",
		...
		date: "Mar 2025",
		title: "Leasy",
		description: "Lightweight task management application with real-time collaboration features and intuitive interface.",
	...
	},
	{
		...
		date: "Dec 2024",
		title: "RNZ",
		description: "Autonomous navigation system with advanced path planning and obstacle avoidance capabilities.",
		tags: ["C++", "ROS 2", "Nav2", "SLAM"],
	},
	{
