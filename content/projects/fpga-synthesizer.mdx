...
category: Hardware
repository: ryryry-3302/fpga_frequency_synthesizer
date: 2024-07-31
previewType: image
previewSrc: "https://opengraph.githubassets.com/1/ryryry-3302/fpga_frequency_synthesizer"
previewAlt: Repository preview for the FPGA frequency synthesizer project.
published: true
---
...
- **High Precision Synchronization**: Achieved 6.5–9.0 ns precision for 1PPS synchronization using Verilog and GOWIN IP cores.
- **Hardware Implementation**: Engineered the solution on Tang Nano 20K FPGA architecture.
- **Signal Processing**: Implemented 1PPS input synchronisation and output generation.
- **Communication Interface**: Developed UART Communications for Phase modulation, Pulse width modulation, and System Reset.
- **Validation**: Verified frequency stability using Allan deviation calculations with Stable32.
